...
import org.seekloud.theia.protocol.ptcl.CommonInfo.{LiveInfo, RoomInfo, UserInfo}
...
import org.seekloud.theia.protocol.ptcl.server2Manager.CommonProtocol.VerifyRsp
import org.seekloud.theia.roomManager.Boot.{executor, roomManager, scheduler, timeout}
import org.seekloud.theia.roomManager.common.{AppSettings, Common}
import org.seekloud.theia.roomManager.core.UserActor.ChildDead
import org.seekloud.theia.roomManager.models.dao.{AdminDAO, UserInfoDao}
