...
import org.seekloud.theia.protocol.ptcl.distributor2Manager.DistributorProtocol
import org.seekloud.theia.protocol.ptcl.distributor2Manager.DistributorProtocol.{StartPullReq, StartPullRsp, FinishPullReq, CheckStreamReq, CheckStreamRsp, SeekRecord, RecordInfoRsp}
import org.seekloud.theia.roomManager.common.AppSettings.{distributorDomain, distributorUseIp, distributorIp, distributorPort}
import org.seekloud.theia.roomManager.http.ServiceUtils.CommonRsp
import org.seekloud.theia.roomManager.utils.ProcessorClient.{log, postJsonRequestSend}
...
//  val distributorBaseUrl = s"http://10.1.29.248:30389/theia/distributor"

  val distributorBaseUrl = s"${if (!distributorUseIp) s"https://$distributorDomain" else s"http://$distributorIp:$distributorPort"}/theia/distributor"
