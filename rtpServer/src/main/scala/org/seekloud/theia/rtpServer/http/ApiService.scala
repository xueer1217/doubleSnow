package org.seekloud.theia.rtpServer.http

import akka.http.scaladsl.server.Directives.{complete, path, pathPrefix}
import org.seekloud.theia.rtpServer.utils.CirceSupport
import akka.http.scaladsl.server.Route
import akka.http.scaladsl.server.Directives._
import org.seekloud.theia.rtpServer.Boot.{dataStoreActor, publishManager, queryInfoManager, streamManager, userManager}
import org.seekloud.theia.rtpServer.core._
import org.seekloud.theia.rtpServer.protocol.ApiProtocol._
import akka.actor.typed.scaladsl.AskPattern._
import akka.http.scaladsl.model.{ContentTypes, HttpEntity}
import net.sf.ehcache.search.query.QueryManager
import org.seekloud.theia.rtpServer.core.DataStoreActor.AllStreamData
import org.seekloud.theia.rtpServer.protocol.{ErrorRsp, SuccessRsp}
