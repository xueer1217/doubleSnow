...
import org.seekloud.theia.protocol.ptcl.client2Manager.http.StatisticsProtocol.{LoginInDataByHourReq, LoginInDataInfo, LoginInDataRsp, WatchDataByHourInfo, WatchDataByHourReq, WatchDataByHourRsp, WatchProfileDataByRecordIdReq, WatchProfileDataByRecordIdRsp, WatchProfileInfo}
import org.seekloud.theia.webClient.common.Components.{AdminHeader, PopWindow}
import org.seekloud.theia.webClient.common.{Page, Routes}
import org.seekloud.theia.webClient.util.{EChart, Http, TimeTool}
...
class AdminPeoplePage extends Page{
  ...
  def init() ={
    //初始化时间选择框
    import org.seekloud.theia.webClient.util.layDate._
    laydate.render(
      new Options {
